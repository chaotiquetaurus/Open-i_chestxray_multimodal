...
- **Loss:** BCEWithLogitsLoss with per-class positive weights (handles imbalance)
...
Weak classes (Nodule, Scoliosis, Fracture) are likely limited by very few training samples.
